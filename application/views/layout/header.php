...
<head>
  <meta charset="utf-8">
  <title>Pako E-sport</title>
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
  <meta content="" name="keywords">
  <meta content="" name="description">

  <!-- Favicons -->
  <link href="<?php echo base_url('application/template/img/favicon.png'); ?>" rel="icon">
...
<link href="https://cdn.jsdelivr.net/npm/sweetalert2@11.0.19/dist/sweetalert2.min.css" rel="stylesheet">
  ...
  <!-- Libraries CSS Files -->
  <link href="<?php echo base_url('application/template/lib/font-awesome/css/font-awesome.min.css'); ?>" rel="stylesheet">
