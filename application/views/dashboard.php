  ...
  <main id="main">
    ...
    <section id="teams" class="section-with-bg wow fadeInUp">
      ...
      <div class="container">
        <div class="section-header">
          <h2>Teams</h2>
          <p>Here are some team that has been registered</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hotel">
              <div class="hotel-img">
                <img src="application/template/img/hotels/1.png" alt="Hotel 1" class="img-fluid">
              </div>
              <h3><a href="#">Inko Gaming</a></h3>
              <div class="stars">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hotel">
              <div class="hotel-img">
                <img src="application/template/img/hotels/2.png" alt="Hotel 2" class="img-fluid">
              </div>
              <h3><a href="#">Pako Gaming</a></h3>
              <div class="stars">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hotel">
              <div class="hotel-img">
                <img src="application/template/img/hotels/3.png" alt="Hotel 3" class="img-fluid">
              </div>
              <h3><a href="#">Assy gaming</a></h3>
              <div class="stars">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
